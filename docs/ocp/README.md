...
| --- | --- | --- | --- |
| 1 | Notificaciones | `exercises/ocp/ex01/NotificationService.java` | WhatsApp o push |
| 2 | Pagos | `exercises/ocp/ex02/PaymentService.java` | Nequi o transferencia |
| 3 | Exportación | `exercises/ocp/ex03/FileExporter.java` | JSON, XML o Excel |
| 4 | Envíos | `exercises/ocp/ex04/ShippingCalculator.java` | Same Day o dron |
| 5 | Ataques | `exercises/ocp/ex05/AttackService.java` | Hielo o electricidad |
