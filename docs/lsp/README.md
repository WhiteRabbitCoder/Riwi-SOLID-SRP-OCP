...
| --- | --- | --- | --- |
| 1 | Aves y vuelo | `exercises/lsp/ex01` | ¿Toda ave cumple el contrato de volar? |
| 2 | Rectángulos y cuadrados | `exercises/lsp/ex02` | ¿Se pueden modificar ancho y alto de manera independiente? |
| 3 | Cuentas bancarias | `exercises/lsp/ex03` | ¿Toda cuenta permite retirar dinero? |
| 4 | Pagos y reembolsos | `exercises/lsp/ex04` | ¿Todo pago promete reembolso digital? |
| 5 | Archivos | `exercises/lsp/ex05` | ¿Todo archivo legible también es escribible? |
